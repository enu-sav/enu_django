...
class Osoba(models.Model):
    ...
    titul_pred_menom = models.CharField("Titul pred menom", max_length=100)
    meno = models.CharField("Meno", max_length=200)
    priezvisko = models.CharField("Priezvisko", max_length=200)
    titul_za_menom = models.CharField("Titul za menom", max_length=100)
    posobisko = models.CharField("Pôsobisko", max_length=200)
    ...
    def nedavno_pridane(self):
        return self.datum_pridania >= timezone.now() - datetime.timedelta(days=1)
