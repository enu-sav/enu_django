...
class PrijataFakturaAdmin(ZobrazitZmeny, AdminChangeLinksMixin, SimpleHistoryAdmin, ModelAdminTotals):
    ...
    list_display = ["cislo", "objednavka_zmluva_link", "url_faktury", "suma", "sadzbadph", "prenosDP", "zrusena", "podiel2", "predmet", "platobny_prikaz", "dane_na_uhradu", "uhradene_dna", "mena", "zdroj", "zakazka", "zdroj2", "zakazka2", "ekoklas"]
...
class NajomneFakturaAdmin(ZobrazitZmeny, AdminChangeLinksMixin, SimpleHistoryAdmin, ImportExportModelAdmin):
    ...
    list_display = ("cislo", "cislo_softip", "zo_softipu", "zmluva_link", "typ", "splatnost_datum", "dane_na_uhradu", "uhradene_dna", "suma", "dan", "platobny_prikaz")
